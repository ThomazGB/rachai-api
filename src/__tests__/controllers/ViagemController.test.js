...
describe('ViagemController', () => {
    describe('POST /viagens/nova_viagem', () => {
        it('should create a new viagem and return 201', async () => {
            ...
            ViagemService.criarViagem.mockResolvedValue(viagemData);
            ...
            expect(response.body.viagem).toEqual(viagemData);
        });
    ...
    describe('GET /viagens/viagem/:id', () => {
        it('should return a viagem by id and return 200', async () => {
            ...
            const response = await request(app).get('/viagens/viagem/1');
    ...
    describe('GET /viagens/usuario/:id/viagens', () => {
        it('should return viagens by usuario id and return 200', async () => {
            const viagens = [{ id: 1 }, { id: 2 }];
            ViagemService.encontrarViagensPorUsuarioId.mockResolvedValue(viagens);

            const response = await request(app).get('/viagens/usuario/1/viagens');
        ...
        it('should return 500 if there is an error', async () => {
            ViagemService.encontrarViagensPorUsuarioId.mockRejectedValue(new Error('Erro ao encontrar as viagens'));
    ...
    describe('PUT /viagens/editar_viagem/:id', () => {
        it('should update a viagem and return 200', async () => {
            const viagemData = {
                status: 'active',
                local_partida: 'A',
                destino: 'B',
            ...
            ViagemService.atualizarViagemPorId.mockResolvedValue(viagemData);
    ...
    describe('DELETE /viagens/deletar_viagem/:id', () => {
        it('should delete a viagem and return 200', async () => {
            ViagemService.deletarViagemPorId.mockResolvedValue(true);

            const response = await request(app).delete('/viagens/deletar_viagem/1');
